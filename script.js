...
function configurarBotoes() {
  ...
  if (isMobile) {
    ...
    let tecladoX = width/2 - 130;
    let infosBotoes = [
      { label: '1', x: 10, y: 0 },   { label: '2', x: 90, y: 0 },   { label: '3', x: 170, y: 0 },
      { label: '4', x: 10, y: 65 },  { label: '5', x: 90, y: 65 },  { label: '6', x: 170, y: 65 },
      { label: '7', x: 10, y: 130 }, { label: '8', x: 90, y: 130 }, { label: '9', x: 170, y: 130 },
      { label: 'C', x: 10, y: 195 }, { label: '0', x: 90, y: 195 }, { label: '←', x: 170, y: 195 }
    ];
    
    for (let b of infosBotoes) {
      botoesNum.push({ label: b.label, x: tecladoX + b.x, y: startY + b.y, w: 65, h: 50 });
    }
    
    // Produtos em linha vertical
